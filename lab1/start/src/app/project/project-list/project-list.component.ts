/**
 * TODO: Create a new component that accepts a list of projects as an input and iterates on the list to display those
 * components.
 *
 * 1. Import Component and OnInit from angular core.
