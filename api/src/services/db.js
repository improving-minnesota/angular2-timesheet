module.exports = (function () {
  ...
  var initDb = function initDb() {
    ...
    db.users = new DataStore({filename: 'datastore/data/db/users.json', autoload: true});
    db.users.ensureIndex({fieldName: 'username', unique: true});
    db.users.ensureIndex({fieldName: 'email', unique: true});

    db.timesheets = new DataStore({filename: 'datastore/data/db/timesheets.json', autoload: true});
    db.timeunits = new DataStore({filename: 'datastore/data/db/timeunits.json', autoload: true});

    db.projects = new DataStore({filename: 'datastore/data/db/projects.json', autoload: true});
